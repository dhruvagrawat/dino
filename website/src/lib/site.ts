...
export const site = {
  ...
  studio: 'Quadcydle',
  email: 'hey@dhruvagrawat.com',
  phone: '9205252966',
  location: 'Delhi, India',
  github: 'https://github.com/dhruvagrawat/dino',
  githubUser: 'https://github.com/dhruvagrawat',
...
export const features = [
  ...
  },
  {
    icon: '📴',
    title: '100% offline',
    body: 'No account, no internet, no ads. Every score and unlock lives on your phone.',
  },
  {
    icon: '🔒',
